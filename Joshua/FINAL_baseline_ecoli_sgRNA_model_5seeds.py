...
print(f"Engineered features present in input CSV: {int(engineered_mask.sum())}")
...
metadata = {
    ...
    "note": (
        "Leakage-safe five-seed baseline using only original features. "
